...
export const AvailableUnitsModal = () => {
    ...
    return (
        <>
            <div className="absolute left-0 right-0 mt-2 mx-6 bg-white shadow-xl rounded-2xl px-5 py-4 text-sm z-40"
            >
                ...
                <div>
                    {selectedTab === "Units" && <UnitDetailsSection
                        title="1 Bedroom"
                        ...
                        onRequestTour={() => console.log("Tour Requested")}
                    />}
...
const UnitDetailsSection: React.FC<UnitDetailsSectionProps> = ({
    ...
    return (
        <div className="rounded-xl shadow-md overflow-hidden relative p-6 mx-5 mt-12 text-black bg-[#D9D9D9]">
                    ...
                    <div className="mt-5 space-y-2 md:text-lg text-md">
                        <div className="flex flex-col md:flex-row md:items-start justify-between">
                            ...
                            <div className="hidden md:flex">
                                <button className="bg-[#B3322F] text-white px-8 py-2 text-center rounded-full text-xs mx-auto">
                                    View All Matches
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row py-3 gap-3">
                            ...
                            <div className="flex md:items-start justify-center">
                                <button className="bg-[#B3322F] text-white px-3 py-2 text-center rounded-full text-xs mt-2">
    ...
    return (<>
        ...
        <div className="w-full  pb-5 px-4">
            <div className="flex flex-col md:flex-row gap-3 md:gap-4 justify-center max-w-4xl mx-auto">
                <button className="bg-black text-white px-6 py-2 md:w-45 rounded-full text-sm font-medium hover:bg-gray-800 transition duration-200"> Accept </button>
                <button className="bg-black text-white px-6 py-2 md:w-45 rounded-full text-sm font-medium hover:bg-gray-800 transition duration-200"> Request Tour </button>
                <button className="bg-black text-white px-6 py-2 md:w-45 rounded-full text-sm font-medium hover:bg-gray-800 transition duration-200"> Decline </button>
            </div>
        </div>
    </>)
}
