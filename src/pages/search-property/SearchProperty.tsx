import { ArrowDownIcon, ArrowLeftIcon, ArrowRightIcon, ArrowUpIcon, ChevronUpDownIcon, ChevronUpIcon } from '@heroicons/react/16/solid'
import { ChevronDownIcon, StarIcon, XMarkIcon } from '@heroicons/react/20/solid'
...
const ChatButton = () => {
    ...
    return (
        <div className="fixed right-0 bottom-1/5 z-50">
            <motion.button
                onClick={handleClick}
...
const ResponsiveTabSelector = () => {
    ...
    const [selectedOccupancies, setSelectedOccupancies] = useState(null);
...
function NumberInput({ label, value, onChange }: NumberInputProps) {
    ...
    const handleManualChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        onChange(isNaN(newVal) ? 0 : Math.max(0, newVal));
    };
