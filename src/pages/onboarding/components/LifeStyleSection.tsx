...
const WhatDoYouEnjoySections: React.FC<{
  ...
  const getInterestNames = (category: string): string[] =>
    data
      ?.find((d: InterestCategory) => d.categoryName === category)
      ?.interests?.map((i: Interest) => i.interestId) || [];
  ...
  const sections = [
    ...
    },
    {
      ...
      selected: selectedStayingIn,
      img: "staying_in.svg",
    },
    {
      name: "CAUSES",
      title: "Causes",
      options: causesInOptions,
  ...
  const totalSelected =
    ...
    selectedStayingIn.length +
    selectedCauses.length +
    selectedPersonal.length;
  ...
  return (
    <div id="enjoy" className={`${error && disabled ? "bg-[#B3322F]/20" : ""}`}>
      ...
      <div className="flex flex-wrap justify-center gap-6 md:px-16 mt-10">
        {sections.map(({ title, options, selected, name, img }) => (
          <div
            id={title}
            key={title}
            className={`w-full sm:w-[45%] lg:w-[23%] rounded-2xl mx-1 md:px-2 px-10 py-5  `}
          >
            ...
            {isLoading ? (
              ...
              <MultiSelectWithIds
                ...
                setSelected={(newSelected) =>
                  handleAnswer(sectionName, name, newSelected)
                }
              />
            )}
          </div>
      ...
      <NextButton
        onClick={disabled ? scrollHandler : nextStep}
...
const BedTimeSections: React.FC<{
  ...
  const disabled =
    answers.goingOutFrequency === null || answers.bedtime === null;

  return (
    <>
      <div
        id="goingOutFrequency"
        className={`  rounded-2xl mx-1 py-10 ${
          error && answers.goingOutFrequency === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        <QuestionTitle>
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.goingOutFrequency === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "goingOutFrequency", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        ...
        className={`mt-1  rounded-2xl mx-1 py-10 ${
          error && answers.bedtime === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        <QuestionTitle>What time do you typically go to bed?</QuestionTitle>
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center text-md px-10 mt-10">
          {[
            ...
            <PrimaryButton
              selected={answers.bedtime === btn.value}
              onClick={() => handleAnswer(sectionName, "bedtime", btn.value)}
            >
              {btn.name}
            </PrimaryButton>
          ))}
...
const LifestylePreferencesSection: React.FC<{
  ...
  const disabled =
    answers.cannabisFrequency === null || answers.tidinessLevel === null;

  return (
    <>
      <div
        id="cannabisFrequency"
        className={`mt-10 rounded-2xl mx-1 py-10 ${
          error && answers.cannabisFrequency === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        <QuestionTitle>
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.cannabisFrequency === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "cannabisFrequency", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        id="tidinessLevel"
        className={`mt-1  rounded-2xl mx-1 py-10 ${
          error && answers.tidinessLevel === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center text-md px-10 mt-10">
          {[
            ...
            <PrimaryButton
              selected={answers.tidinessLevel === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "tidinessLevel", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
...
const DrinkAndSmokeSection: React.FC<{
  ...
  const disabled =
    answers.drinkingFrequency === null || answers.smokingFrequency === null;
  ...
  return (
    <>
      <div
        ...
        className={`rounded-2xl mx-1 py-10 ${
          error && answers.drinkingFrequency === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        <QuestionTitle>How often do you drink?</QuestionTitle>
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.drinkingFrequency === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "drinkingFrequency", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        id="smokingFrequency"
        className={`mt-1 rounded-2xl mx-1 py-10 ${
          error && answers.smokingFrequency === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        <QuestionTitle>How often do you smoke?</QuestionTitle>
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center text-md px-10 mt-15">
          {[
            ...
            <PrimaryButton
              selected={answers.smokingFrequency === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "smokingFrequency", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
  ...
  return (
    <div className="text-center mt-35">
      <p className="text-3xl text-[#B3322F]">
        Let's learn about your lifestyle, <br />{" "}
        <span className="font-bold">{name}</span>
      </p>
      <img
        alt=""
        className="h-40 pr-1 mx-auto "
        src="/assets/img/icons/lifestyleicon.svg"
      />
      <p className="text-md pb-10">
        {" "}
        Knowing your habits helps us match
        <br /> you with the best roommates and home{" "}
      </p>
...
const AreaOfStudyDescription: React.FC<{
  ...
  return (
    <div className="text-center ">
      ...
      >
        <p className="text-3xl text-[#B3322F] mb-10 px-10">
