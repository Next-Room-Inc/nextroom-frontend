  ...
  return (
    <div className="text-center mt-35">
      <p className="text-3xl text-[#B3322F]">
        Let's discover your roommate preferences, <br />{" "}
        <span className="font-bold">{name}</span>
      </p>
      <img
        alt=""
        className="h-30 py-5 pr-1 mx-auto "
        src="/assets/img/icons/roomateicon.svg"
      />
      <p className="text-md pb-10">
        {" "}
        This allows us to match you with your
        <br />
        perfect roommate{" "}
      </p>
    ...
    <>
      <div
        ...
        className={` rounded-2xl mx-1 py-10 ${
          error && answers.genderComfort === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        {/* Question */}
        <QuestionTitle>
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            {
              name: "Yes - Separate Bedrooms",
              value: "Yes - Separate Bedrooms",
            },
            { name: "Doesn’t Matter", value: "Doesn’t Matter" },
            { name: "No", value: "No" },
          ].map((btn) => (
            <PrimaryButton
              selected={answers.genderComfort === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "genderComfort", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        id="culturalOpenness"
        className={`my-1 rounded-2xl mx-1 py-10 ${
          error && answers.culturalOpenness === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        {/* Question */}
        <QuestionTitle>
          How open are you to living with someone from a different cultural or
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.culturalOpenness === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "culturalOpenness", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        id="guestFrequency"
        className={` rounded-2xl mx-1 py-10 ${
          error && answers.guestFrequency === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        {/* Question */}
        <QuestionTitle>Do you like to have guests over?</QuestionTitle>
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.guestFrequency === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "guestFrequency", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
...
const GuestAndFriendSection: React.FC<{
  ...
  console.log("answers==> ROOM", answers);
  const disabled =
    answers.roommateGuestsOk === null ||
    answers.weekdayGuestLimit === null ||
    answers.studyInUnit === null;
  return (
    <>
      <div
        id="roommateGuestsOk"
        className={` rounded-2xl mx-1 py-10 ${
          error && answers.roommateGuestsOk === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        {/* Question */}
        <QuestionTitle>
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.roommateGuestsOk === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "roommateGuestsOk", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        id="weekdayGuestLimit"
        className={`my-1 rounded-2xl mx-1 py-10 ${
          error && answers.weekdayGuestLimit === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        {/* Question */}
        <QuestionTitle>
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.weekdayGuestLimit === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "weekdayGuestLimit", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        id="studyInUnit"
        className={` rounded-2xl mx-1 py-10 ${
          error && answers.studyInUnit === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        {/* Question */}
        <QuestionTitle>Do you plan to study in your unit?</QuestionTitle>
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            { name: "Yes", value: "Yes" },
            { name: "No", value: "No" },
            ...
            <PrimaryButton
              selected={answers.studyInUnit === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "studyInUnit", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
...
const CookAndExpensesSection: React.FC<{
  ...
  const disabled =
    answers.cookingPlans === null ||
    answers.expenseSharing === null ||
    answers.friendshipImportance === null ||
    answers.communicationFrequency === null;
  ...
  return (
    <>
      <div
        id="cookingPlans"
        className={` rounded-2xl mx-1 py-10 ${
          error && answers.cookingPlans === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        {/* Question */}
        <QuestionTitle>Do you plan to cook?</QuestionTitle>
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            { name: "Yes", value: "Yes" },
            { name: "No", value: "No" },
            ...
            <PrimaryButton
              selected={answers.cookingPlans === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "cookingPlans", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        ...
        className={`mt-1 rounded-2xl mx-1 py-10 ${
          error && answers.expenseSharing === null ? "bg-[#B3322F]/20" : ""
        }`}
      >
        {/* Question */}
        <QuestionTitle>
          How do you feel about sharing expenses (e.g. rent, utilities,
          groceries)
        </QuestionTitle>
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.expenseSharing === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "expenseSharing", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        id="friendshipImportance"
        className={`mt-1 rounded-2xl mx-1 py-10 ${
          error && answers.friendshipImportance === null
            ? "bg-[#B3322F]/20"
            : ""
        }`}
      >
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.friendshipImportance === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "friendshipImportance", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <div
        ...
        className={`mt-1 rounded-2xl mx-1 py-10 ${
          error && answers.communicationFrequency === null
            ? "bg-[#B3322F]/20"
            : ""
        }`}
      >
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-15 justify-center items-center mt-15 text-md px-10">
          {[
            ...
            <PrimaryButton
              selected={answers.communicationFrequency === btn.value}
              onClick={() =>
                handleAnswer(sectionName, "communicationFrequency", btn.value)
              }
            >
              {btn.name}
            </PrimaryButton>
      ...
      <NextButton
        onClick={disabled ? scrollHandler : nextSectionHandler}
        previousStepHandler={previousStepHandler}
      />
    </>
  );
