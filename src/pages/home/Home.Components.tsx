    ...
    <>
      ...
      h-[120vh] md:h-[100vh]  bg-cover bg-bottom  md:bg-center bg-[url(/assets/img/backgrounds/backgrounds_1_2.png)] md:bg-[url(/assets/img/backgrounds/backgrounds_1.png)]"
        >
          <div className="md:w-[50%] md:pl-20 w-[90%] pt-10">
            ...
            <button className="bg-[#000000] text-white font-medium px-8 py-3 rounded-full shadow-md cursor-pointer hover:bg-red-800  ">
        ...
        <div className="text-center z-1 bg-transparent sticky top-8">
          <button className="bg-[#B3322F] cursor-pointer hover:bg-black text-white font-medium py-3 w-[250px]  sm:w-[347px] md:w-[500px] mx-auto rounded-full shadow-md z-10 -top-5 relative -mt-10">
      ...
      h-[100vh]  bg-cover bg-center  md:bg-top bg-[url(/assets/img/backgrounds/backgrounds_5_2.png)] md:bg-[url(/assets/img/backgrounds/backgrounds_5.png)]"
        ...
        <div className="text-center">
          ...
          <button className="bg-[#000000] text-white font-medium px-15 md:px-15 py-3 rounded-full mx-auto mb-10 shadow-sm shadow-black cursor-pointer hover:bg-red-800">
            Try It Now
          </button>
          {/* Vedio player */}
          <div className="relative rounded-xl overflow-hidden w-full my-10 md:px-10 px-4">
            <video
      ...
      h-[120vh] w-full bg-cover bg-center bg-[url(/assets/img/backgrounds/backgrounds_6_2.png)] md:bg-[url(/assets/img/backgrounds/backgrounds_6.png)]"
        >
          <div className="md:w-[50%] md:pl-20 w-[90%] pt-5">
            ...
            <p className="text-white text-sm md:text-xl md:leading-relaxed max-w-xl mx-auto lg:mx-0 mb-6 ">
              ...
              landlord on our site is screened, and all listings are verified
              for accuracy and legitimacy. Plus, only students can join,
              creating a trusted, secure space tailored just for student
              housing.
            </p>

            <div>
              <button className="bg-[#B3322F] text-white font-medium px-22 py-3 rounded-full shadow-md cursor-pointer hover:bg-black">
                Learn More
              </button>
            </div>
          </div>
        ...
        >
          ...
          <p className="text-gray-700 max-w-3xl  mx-auto md:text-lg text-md leading-relaxed mb-6">
            ...
            . Like building a real home, the walls, the roof, the
            foundation—they all matter. At Next Room, every piece—housing,
            roommates, sublets, support—fits together to give students a
