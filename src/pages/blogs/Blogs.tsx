      ...
      <div className="py-15 md:mx-15">
        <div className="mx-4">
          ...
          <div className="  mx-1 md:mx-5   bg-white shadow-xl rounded-2xl mb-15 py-5 px-4 md:px-10">
            <p className="text-[#B3322F] font-bold text-xl text-center">
              Site Updates Now Live!
            </p>
            <p className="font-semibold text-sm px-4 mb-3 text-center">
              September 1, 2025
            </p>
            {/* Vedio */}
            ...
            <p className="text-[#B3322F] font-bold text-md px-4 flex -ml-4">
              View Full Transcript <ChevronDownIcon className="h-6 mt-0.5" />
            </p>
            <p>
              Finding the right place to live while studying in Ottawa just got
              easier. NextRoom, the go-to platform for student rentals, has
              introduced a fresh update packed with features designed
              specifically for students navigating the rental market.
            </p>
            <div>
              <motion.button
                whileTap={{ scale: 0.95 }}
          ...
          <div className="  mx-1 md:mx-5   bg-white shadow-xl rounded-2xl mb-15 py-5">
            <p className="text-[#B3322F] font-bold text-xl px-4">
              Site Updates Now Live!
            </p>
                ...
                <div className="w-fullflex flex-col justify-top">
                  ...
                  <div className="mt-5 space-y-1 md:text-md text-md">
                    <p className="  text-white">
                      {item.trending && (
                        <span className="bg-[#B3322F] flex w-fit justify-center items-center rounded-sm px-4 text-xs py-0.5 ">
                          Trending
                          <img
                    ...
                    <p className="text-[#B3322F] font-bold text-xl">
                      Site Updates Now Live!
                    </p>
