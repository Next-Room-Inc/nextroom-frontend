...
import {
  Property,
  PropertyDetails,
} from "@src/utils/interfaces/property.interface";
        ...
        >
          ...
          <div className="flex justify-between flex-col md:flex-row">
            <div className="md:text-left text-center">
              <h1 className="underline font-bold">
                30 rue Jos-Montferrand, Gatineau
              </h1>
              ...
              <h1 className="text-[#B3322F] font-bold">
                ${propertyDetails.rentMin} - ${propertyDetails.rentMax} monthly
              </h1>
            </div>
          ...
          <div>
            ...
            {selectedTab === "Building" && (
              <BuildingDetailSection propertyDetails={propertyDetails} />
            )}
...
}> = ({ propertyDetails, title, status, amenities }) => {
      ...
      {(propertyDetails?.availableUnits?.unit || []).map((unit) => (
        <>
          <motion.div
            ...
            className="  border-b-1 border-gray-300 overflow relative px-6  mt-12 text-black  "
          >
              ...
              <div className="w-full md:pl-6 md:mt-0 mt-6 flex flex-col justify-center">
                ...
                <div className="mt-5 space-y-2 md:text-lg text-md">
                  <div className="flex flex-col md:flex-row md:items-start justify-between">
                    ...
                    <div className="md:mt-0 mt-2"></div>
                  </div>
...
const MediaGallery = () => {
  const imageList = [
    {
      src: "/assets/img/search-property/demo_gallary_image_1.png",
      alt: "Bedroom",
    },
    {
      src: "/assets/img/search-property/demo_gallary_image_2.png",
      alt: "Kitchen",
    },
    {
      src: "/assets/img/search-property/demo_gallary_image_3.png",
      alt: "Living Room",
    },
    {
      src: "/assets/img/search-property/demo_gallary_image_1.png",
...
const BuildingDetailSection: React.FC<{
  ...
  const description =
    propertyDetails?.description || "No description Added yet";
    ...
    >
      <div className="flex flex-col md:flex-row gap-y-5 ">
        <div className="md:w-[50%] w-full">
          <p className="text-center font-bold mb-3 text-[#B3322F] ">
            Price Changes Year Over Year <br className="md:hidden flex" />{" "}
            (2021-2024)
          </p>
          <div className="flex gap-3  justify-center mx-auto ">
            <Button className="bg-[#B3322F] text-white  py-1 w-25 rounded-full text-sm font-medium hover:bg-gray-800 transition duration-200">
              {" "}
              Studio{" "}
            </Button>
            <Button className="bg-[#B3322F] text-white  py-1 w-25 rounded-full text-sm font-medium hover:bg-gray-800 transition duration-200">
      ...
      <div className=" mx-auto p-4 space-y-10 text-sm text-gray-800">
        ...
        <section>
          ...
          <div className="space-y-2 border-b pb-4">
            ...
            <p>
              I've been living in this apartment for almost a year, and overall
              it's been a great experience. The location is super
              ...
              sometimes hear your neighbors. Maintenance responds pretty quickly
              to issues, which I really appreciate. It's a bit pricey for a
              student budget, but the convenience makes it worth it.
            </p>
          </div>
          ...
          <div className="space-y-2 mt-4">
            ...
            <p>
              About two months into my lease, the heating stopped working in the
              middle of a cold snap. I submitted a repair request through the
              online portal, and to my surprise, the property manager got back
              to me the same day. A technician came by the next morning and had
              it fixed within an hour. I was honestly expecting a longer wait
              based on past rentals, so I was impressed. It's not a perfect
              apartment—noise can be an issue on weekends—but the quick response
              made me feel like the management actually cares.
            </p>
        ...
        <section>
          ...
          <div className="  rounded-md  space-y-2">
            ...
            <div>
              <span className="font-semibold">Details:</span> I wanted to let
              you know that the washing machine in our unit has stopped working
              — it won’t start even when plugged in and the cycle won’t begin.
              Could you please arrange for a repair as soon as possible? Let me
              know if you need any more details or if someone will be coming by.
            </div>
