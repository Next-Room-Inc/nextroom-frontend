                ...
                {listings.map((listing) => (
                    ...
                    >
                        <div className="relative isolate flex flex-col gap-8 lg:flex-row">
                            {/* IMAGE SECTION */}
                            <div
                                className="relative aspect-video sm:aspect-2/1 lg:aspect-square lg:w-110 lg:h-50 lg:shrink-0">
                                {/* <img
                  alt=""
                  src={APP_INFO.DEMO}
                ...
                /> */}
                        ...
                        <div className="container px-3 -mt-5">
                            ...
                            <div className="container flex lg:block">
                                <div
                                    className=" w-[60%] lg:w-[100%] grid grid-cols-1 lg:grid-cols-4 lg:border py-2  lg:px-4 rounded-full border-black">
                                    {/* ITEMS */}
                                ...
                                <div
                                    className="w-[40%] lg:w-[100%] grid grid-cols-1 lg:grid-cols-4 py-2 px-4 text-[#B3322F]">
                                    {/* ITEMS */}
