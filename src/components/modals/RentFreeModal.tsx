        ...
        >
          ...
          <div className="flex bg-red-800 h-[100%] flex-col justify-center items-center text-white p-8 md:w-1/2 w-full">
            ...
            <div className="w-full flex flex-col gap-3">
              <button className="bg-white text-black shadow-white shadow-sm py-3 rounded-md font-semibold hover:bg-gray-100 transition">
                Yes, I’m Interested
              </button>
              <button className="bg-red-900 shadow-black shadow-sm text-white py-3 rounded-md font-semibold hover:bg-[#841717] transition">
                No, Thanks
              </button>
            </div>
          </div>
