        ...
        {features.map((feature, index) => (
          <SwiperSlide key={index}>
            <div
              ...
              style={{ backgroundImage: `url(public/assets/img/images/${feature.image})`, backgroundSize: "cover", backgroundPosition: "center" }}
            >
              {/* Overlay */}
              <div className="absolute inset-0  p-5 flex flex-col justify-end text-white">
                <div className="flex items-center gap-3 mb-2">
                  <img src={`${APP_INFO.IMG_BASE_URL}images/${feature.icon}`} alt="" className="w-18 h-18 bg-[#B3322F] p-1 rounded-full" />
